...
Produce the **mid-2026 open-source version of Memento** in this repository, superseding the Aug 2025 canon with the lineage's receipted evolution. Charter: `../active-knowledge/CHARTER.md`. Public framing: continuity across hundreds of agent sessions; the framework itself is two-armed (memory prosthesis + operational protocols).
