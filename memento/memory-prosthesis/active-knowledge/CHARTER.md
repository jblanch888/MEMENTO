---
description: founding charter of the MEMENTO estate — mandate, stance, seam doctrine and gates for the mid-2026 open-source canon endeavour
type: governing
date: 2026-07-20
governs: [mandate, stance, canon-estate-seam, publication]
last_verified: 2026-07-20
status: governing
---

# CHARTER — the mid-2026 canon endeavour

## Mandate

Produce the **mid-2026 open-source version of Memento** in this repository: supersede the Aug 2025 canon with what the deployment lineage has learned since, receipted and honestly labelled. The public framing is the User's published thesis: **continuity across hundreds of agent sessions, not autonomy within one** — which source is current truth, which decisions still stand, what was tried and rejected, what the user actually validated.

## Stance

1. **Evidence over assertion.** Every claim the canon publishes traces to lineage receipts (CD #13). The differentiator of this framework's story is that it can show its evidence — including its dead mechanisms and why they died. No invented history.
...
**Provenance:** authored at founding (Slice 1, 2026-07-20) under the fitted CORE_DIRECTIVES; stance items 1–4 condense the User's rulings of 2026-07-20 (cross-pollination correction; new-epoch/early-days framing; evidence-first canon); item 5 holds the adoption-model question open per PLANNING §3C options-neutral discipline.
