...
- **Spine frontmatter** on every memo (`framework/conventions/ESTATE_SPINE.md`), with `status:` tracking the memo's life (awaiting-approval / approved / superseded / historical).
